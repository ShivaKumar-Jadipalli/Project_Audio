...
import { Typography } from "@/components/argon/components";
        ...
        <div className="container mx-auto grid items-center relative lg:grid-cols-2">
          ...
          <div className="text-center lg:text-left">
            ...
            <Typography color="gray" className="lg:pr-20">
              ...
              they can fit perfectly for your brand. Spend time creating dApps
              logic and UX, our tools take care of the rest.
            </Typography>
          </div>
        </div>
      </div>
