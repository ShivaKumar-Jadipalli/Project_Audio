...
import { Button, Card, Typography } from "@/components/argon/components";
        ...
        <div className="container mx-auto relative">
          <div className="text-left">
            ...
            <Typography color="blue-gray" className="mb-5 lg:w-[25rem]">
              All the sections and pages made with these elements will be fully
              responsive and will look beautiful on all types of screens,
              including phones, tables, or desktops.
            </Typography>
          </div>
