...
import { Button, Typography } from "@/components/argon/components";
        ...
        <div className="container mx-auto grid items-center lg:grid-cols-2">
          <div className="text-center lg:text-left pt-32">
            ...
            >
              ...
              <span className="text-blue">Astro Project</span>
            </Typography>
            <Typography variant="lead" color="blue-gray" className="lg:pr-32">
              ...
              and feature-rich. It comes packed with everything you need to get
              your Online Store ready in no time.
            </Typography>
